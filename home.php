...
<html lang="es">
    ...
    <body>
            ...
            <div id="contenido" class="contenido">
                    ...
                    <div class = "home_btns_div">
                

                      <a href="#" class = "home_btn">Agendar cita</a> 

                      <a href="#" class = "home_btn">Consultar cita</a>

                      <a href="#" class = "home_btn">Posponer cita</a>

                      <a href="#" class = "home_btn">Cancelar cita</a>

                      <a href="#" class = "home_btn">Cerrar sesión</a>
